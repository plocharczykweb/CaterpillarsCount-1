	...
	if ($_SERVER['REQUEST_METHOD'] == "GET" && isset($_REQUEST['action']) && $_REQUEST['action'] == "quizData") {
		...
		$required = array("Araneae", "Auchenorrhyncha", "Coleoptera", "Heteroptera", "Opiliones");
			...
			if ($result->num_rows == 0) {
				...
				$photos = array("https://static.inaturalist.org/photos/3297131/medium.jpg?1459878547","https://static.inaturalist.org/photos/3285686/medium.jpg?1459740754","https://static.inaturalist.org/photos/2254750/medium.JPG?1439339664","https://static.inaturalist.org/photos/3245329/medium.JPG?1459225141","https://static.inaturalist.org/photos/3216215/medium.jpg?1458852346","https://static.inaturalist.org/photos/2950963/medium.jpg?1454227930","https://static.inaturalist.org/photos/2617917/medium.JPG?1446837568","https://static.inaturalist.org/photos/1590335/medium.jpg?1425330543","https://static.inaturalist.org/photos/2104173/medium.jpg?1436381342","https://static.inaturalist.org/photos/2985908/medium.jpg?1454950250");
		...
		$mysqli = mysqli_connect(getenv(strtoupper(getenv('DATABASE_SERVICE_NAME')).'_SERVICE_HOST') . ':' . getenv(strtoupper(getenv('DATABASE_SERVICE_NAME')).'_SERVICE_PORT'),
			$_ENV['MYSQL_USER'],
			$_ENV['MYSQL_PASSWORD'], "caterpillars") or die("Error " . mysqli_error($connection));
