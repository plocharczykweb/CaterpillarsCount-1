				...
				<ul>
					...
					<li onclick="accessSubMenu(this);">
						...
						<ul onclick="event.stopPropagation();">
							...
							<li><a href="https://www.inaturalist.org/observations?place_id=any../recentObservationsuser_id=caterpillarscount../recentObservationsverifiable=any">Recent Observations</a></li>
						</ul>
					</li>
					<li onclick="accessSubMenu(this);">
						<span>Learn</span>
